...
var LogoIconMobile = styled.div(templateObject_2$d || (templateObject_2$d = __makeTemplateObject(["\n  &.mobile-icon {\n    width: 52px;\n    height: 65px;\n  }\n"], ["\n  &.mobile-icon {\n    width: 52px;\n    height: 65px;\n  }\n"])));
var LogoIconDesktop = styled.div(templateObject_3$8 || (templateObject_3$8 = __makeTemplateObject(["\n  &.desktop-icon {\n    width: 84px;\n    height: 101px;\n  }\n"], ["\n  &.desktop-icon {\n    width: 84px;\n    height: 101px;\n  }\n"])));
var Logo$1 = function (_a) {
    var isPushed = _a.isPushed, togglePush = _a.togglePush; _a.isDark; var href = _a.href;
    var isAbsoluteUrl = href.startsWith("http");
    var innerLogo = (React.createElement(React.Fragment, null,
        React.createElement(LogoIconMobile, { className: "mobile-icon" },
            React.createElement("image", { width: "100%", height: "100%", href: "/images/egg/logo.png" })),
        React.createElement(LogoIconDesktop, { className: "desktop-icon" },
            React.createElement("image", { width: "100%", height: "100%", href: "/images/egg/logo.png" }))));
    return (React.createElement(Flex, { flexDirection: "column" },
        ...
        React.createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mx: "8px" }, isPushed ? (React.createElement(Icon$L, { width: "24px", color: "textSubtle" })) : (React.createElement(Icon$K, { width: "24px", color: "textSubtle" })))));
};
...
var Panel = function (props) {
    ...
    return (React.createElement(StyledPanel, { isPushed: isPushed, showMenu: showMenu },
        React.createElement(Logo$1, { isPushed: isPushed, togglePush: togglePush, href: (_a = homeLink === null || homeLink === void 0 ? void 0 : homeLink.href) !== null && _a !== void 0 ? _a : "/" }),
...
var Menu = function (_a) {
    ...
    return (React.createElement(Wrapper$1, null,
        ...
        React.createElement(BodyWrapper, null,
            React.createElement(Panel, { isPushed: isPushed, togglePush: function () { return setIsPushed(function (prevState) { return !prevState; }); }, isMobile: isMobile, showMenu: showMenu, isDark: isDark, toggleTheme: toggleTheme, langs: langs, setLang: setLang, currentLang: currentLang, cakePriceUsd: cakePriceUsd, pushNav: setIsPushed, links: links, priceLink: priceLink }),
